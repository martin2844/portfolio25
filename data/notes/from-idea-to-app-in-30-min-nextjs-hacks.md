...
* **Express design with v0**  
  I use [v0.app](https://v0.app/) to sketch the UI in minutes. I iterate quickly until something “good enough” and only then move on to code. The goal is to unlock the implementation, not win a design award.
...
* Project repo: <https://github.com/martin2844/knext>
* v0 to prototype the UI: <https://v0.app/>
...
> Original article in Spanish: [De idea a app en 30 min | Next.js Hacks](https://codigomate.com/de-idea-a-app-en-30-min-next-js-hacks-1/)